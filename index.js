...
// ─────────────────────────────────────────────────────
//  CATEGORY EMBED BUILDERS  (unchanged)
// ─────────────────────────────────────────────────────
const CAT_COLORS = [
...
function islamEmbed() {
  return new EmbedBuilder()
    ...
    .setDescription(
      ...
      "It is not a new religion. It is the same message brought by every prophet from Adam ﷺ to Muhammad ﷺ: **worship Allah alone and follow His guidance.**"
    )
    .addFields(
      {
      ...
      {
        name: `${E.book} Definition from the Quran`,
        value:
      ...
      },
      {
        ...
        value:
          "A Muslim submits their will, desires, and life entirely to Allah — not out of compulsion, but out of love, knowledge, and conviction. Every aspect of life — worship, family, business, character — is guided by the teachings of the Quran and the Sunnah of the Prophet ﷺ.",
        inline: false,
      },
      {
...
function muslimEmbed() {
  return new EmbedBuilder()
    ...
    .setDescription(
      "A **Muslim** (مُسْلِم) is one who submits entirely to Allah — who surrenders their will, actions, and life to the Creator of the heavens and the earth."
    )
    .addFields(
      {
      ...
      {
        name: `${E.stars} The Rights of a Muslim upon Another Muslim`,
        value:
          "The Prophet ﷺ said:\n*\"The Muslim has five rights over his fellow Muslim: returning the salaam, visiting the sick, following the funeral, accepting the invitation, and saying Yarhamukallah when he sneezes.\"*\n— (Bukhari & Muslim)",
        inline: false,
      },
      {
      ...
      {
        name: `${E.correct} Muslim vs Mu'min`,
        value:
          "**Muslim** — one who has submitted outwardly and inwardly.\n" +
          "**Mu'min** — a Believer, one whose Iman has penetrated deep into the heart.\n" +
          "Every Mu'min is a Muslim, but the station of Iman is higher than mere outward submission. (See Al-Hujurat 49:14)",
        inline: false,
      },
    )
    ...
    .addFields(
      ...
      },
      {
        ...
        value:
          ...
          "A direct connection between the servant and Allah — obligatory upon every sane Muslim who has reached puberty.\n\n" +
          "Use `/salah` for full breakdown.",
        inline: false,
      },
      {
        ...
        value:
          ...
          "Purifies wealth, the soul, and strengthens the community.\n\n" +
          "Use `/zakah` for full breakdown.",
        inline: false,
      },
      {
        name: `${E.correct} 4. Sawm — Fasting Ramadan`,
        value:
          "Fasting the month of **Ramadan** — from Fajr to Maghrib, abstaining from food, drink, and marital relations.\n" +
          "A month of worship, patience, and gratitude.\n\n" +
          "Use `/sawm` for full breakdown.",
        inline: false,
      },
      {
        ...
        value:
          ...
          "The largest annual gathering of Muslims on earth.\n\n" +
...
function pillarsOfImanEmbed() {
  return new EmbedBuilder()
    .setColor(0x3E2723)
    .setTitle("✨  The Six Pillars of Iman (Faith)")
    .setDescription(
      "*\"Iman is to believe in Allah, His angels, His books, His messengers, the Last Day, and to believe in divine decree — both the good and the bad thereof.\"*\n— (Hadith of Jibreel, Sahih Muslim)"
    )
    .addFields(
      {
      ...
      },
      {
        ...
        value:
          "Angels are created from **light**, they do not disobey Allah, and they carry out His commands.\n" +
          "Notable angels: **Jibreel** (revelation), **Mika'eel** (provisions), **Israfeel** (the Trumpet), **Munkar & Nakeer** (the grave), **Malik** (Keeper of Hellfire).",
        inline: false,
      },
      {
        name: `${E.stars} 3. Belief in the Divine Books`,
        value:
          "**Tawrah** (Torah) → Musa ﷺ\n**Injeel** (Gospel) → Isa ﷺ\n**Zabur** (Psalms) → Dawud ﷺ\n**Suhuf** → Ibrahim ﷺ\n**Al-Qur'an** → Muhammad ﷺ *(the final, preserved revelation)*",
        inline: false,
      },
      {
        ...
        value:
          ...
          "Use `/prophetnames` to learn the names & titles of the Prophet ﷺ.",
        inline: false,
      },
      {
        name: `${E.stars} 5. Belief in the Last Day`,
        value:
          "Belief in: **death, the grave, the resurrection, the reckoning, the Bridge (Sirat), Jannah (Paradise), Jahannam (Hellfire)**.\n" +
...
function shahadahEmbed() {
  return new EmbedBuilder()
    .setColor(0x1B5E20)
    .setTitle(`${E.key}  The Shahadah — Declaration of Faith`)
    .setDescription(
      "**أَشْهَدُ أَنْ لَا إِلَٰهَ إِلَّا ٱللَّٰهُ وَأَشْهَدُ أَنَّ مُحَمَّدًا رَسُولُ ٱللَّٰهِ**\n\n" +
    ...
    .addFields(
      {
        ...
        value:
          ...
          "This **negates** all false deities and **affirms** that Allah alone deserves worship.\n\n" +
          "**مُحَمَّدٌ رَسُولُ ٱللَّٰهِ** — *\"Muhammad is the Messenger of Allah\"*\n" +
          "This affirms that we follow his way — the Sunnah — in how we worship Allah.",
        inline: false,
      },
      {
      ...
      {
        name: `${E.stars} Why is it not enough to just say it?`,
        value:
          "Iblis (Shaytan) *knows* Allah exists — but he refuses to submit. Knowledge alone is not enough.\n" +
...
function salahEmbed() {
  return new EmbedBuilder()
    .setColor(0x006064)
    .setTitle(`${E.paper}  Salah — The Five Daily Prayers`)
    .setDescription(
      "*\"Indeed, prayer has been decreed upon the believers a decree of specified times.\"*\n— (An-Nisa 4:103)"
    )
    .addFields(
      { name: `${E.sun} Fajr`,    value: "**2 rakaat** — from true dawn until just before sunrise", inline: true },
      { name: `${E.sun} Dhuhr`,   value: "**4 rakaat** — after the sun passes its zenith until Asr time", inline: true },
      { name: `${E.sun} Asr`,     value: "**4 rakaat** — afternoon until just before sunset", inline: true },
      { name: `${E.sun} Maghrib`, value: "**3 rakaat** — just after sunset until twilight disappears", inline: true },
      { name: `${E.sun} Isha`,    value: "**4 rakaat** — from disappearance of twilight until midnight", inline: true },
      ...
      },
      {
        ...
        value:
          ...
          "Final Tashahhud • Tasleem (Assalamu Alaykum)",
        inline: false,
      },
      {
...
function zakahEmbed() {
  return new EmbedBuilder()
    .setColor(0x4A148C)
    .setTitle(`${E.heart}  Zakah — Obligatory Charity`)
    .setDescription(
    ...
    .addFields(
      {
        ...
        value:
          "Zakah is the **obligatory annual payment of 2.5%** of qualifying wealth given to eligible recipients.\n" +
          "It is one of the five pillars — a right of the poor over the wealthy, and an act of worship.",
        inline: false,
      },
      {
        name: `${E.correct} Conditions`,
        value:
          "Muslim • Sane & Adult • Owns the **Nisab** (minimum threshold) • " +
...
function sawmEmbed() {
  return new EmbedBuilder()
    .setColor(0x880E4F)
    .setTitle(`${E.sandclock}  Sawm — Fasting Ramadan`)
    .setDescription(
    ...
    .addFields(
      {
        ...
        value:
          "Abstaining from **food, drink, marital relations, and all invalidating acts** from true dawn (Fajr) until sunset (Maghrib) throughout the month of **Ramadan**.",
        inline: false,
      },
      {
        name: `${E.correct} Conditions`,
        value:
          ...
          "Free from illness preventing fasting • Not menstruating or in postnatal bleeding",
        inline: false,
      },
      {
      ...
      {
        name: `${E.stars} Laylatul Qadr — The Night of Power`,
        value:
      ...
      {
        name: `${E.rose} Du'a of Breaking Fast (Iftar)`,
        value:
...
function hajjEmbed() {
  return new EmbedBuilder()
    .setColor(0x3E2723)
    .setTitle(`${E.key}  Hajj — The Pilgrimage`)
    .setDescription(
    ...
    .addFields(
      ...
      },
      {
        ...
        value:
          ...
          "**3.** Tawaf al-Ifadah — circling the Ka'bah\n" +
      ...
      },
      {
        ...
        value:
          "**Masjid al-Haram** • **Ka'bah** • **Mina** • **Mount Arafah** • " +
...
function qadarEmbed() {
  return new EmbedBuilder()
    .setColor(0x0D47A1)
    .setTitle(`${E.stars}  Qadar — Divine Decree`)
    .setDescription(
    ...
    .addFields(
      {
        ...
        value:
          ...
          "that He wrote all of it in the **Preserved Tablet (Al-Lawh al-Mahfuz)** 50,000 years before the creation of the heavens and earth, " +
      ...
      },
      {
        ...
        value:
          ...
          "**3. Al-Mashee'ah** — Whatever He wills happens; whatever He does not will, does not happen\n" +
      ...
      },
      {
        ...
        value:
          ...
          "but Allah knew what we would choose before we were created. Our choices are real; His knowledge is perfect and eternal.",
        inline: false,
      },
      {
...
function wuduEmbed() {
  return new EmbedBuilder()
    .setColor(0x006064)
    .setTitle(`${E.waterdrop}  Wudu — Ablution`)
    .setDescription(
      "*\"O you who believe! When you stand for prayer, wash your faces and your forearms to the elbows, wipe your heads, and wash your feet to the ankles.\"*\n— (Al-Ma'idah 5:6)"
    )
    .addFields(
      {
      ...
      },
      {
        ...
        value:
          ...
          "Beginning with the **right side** • Repeating each act **3 times** • " +
          "Saying the du'a after completing wudu",
        inline: false,
      },
      {
        ...
        value:
          ...
          "Loss of consciousness • Touching private parts without barrier *(Shafi'i/Hanbali)* • " +
          "Eating camel meat *(Hanbali)*",
        inline: false,
      },
      {
        name: `${E.rose} Du'a After Wudu`,
        value:
          ...
          "*(Then the eight gates of Jannah are opened for him — Sahih Muslim)*",
        inline: false,
      },
    )
...
function ghuslEmbed() {
  return new EmbedBuilder()
    .setColor(0x004D40)
    .setTitle(`${E.waterdrop}  Ghusl — Ritual Bath`)
    .setDescription(
    ...
    .addFields(
      ...
      {
        name: `${E.correct} Minimum (Fard) Ghusl — 3 Steps`,
        value:
          "**1.** Intention (*Niyyah*)\n" +
...
function tawheedTypesEmbed() {
  return new EmbedBuilder()
    .setColor(0x1B5E20)
    .setTitle(`${E.book}  The Three Categories of Tawheed`)
    .setDescription(
      "The scholars of Ahl al-Sunnah wal-Jama'ah categorise Tawheed into three essential, interconnected divisions:"
    )
    .addFields(
      {
        ...
        value:
          ...
          "Affirming this alone is **not sufficient** for salvation — it was not enough for Fir'awn or Abu Jahl.",
        inline: false,
      },
      {
        name: `${E.stars} 2. Tawheed al-Uluhiyyah — Oneness of Worship`,
        value:
          "Directing **all acts of worship** — prayer, du'a, slaughter, vows, fear, hope, tawakkul, love — to **Allah alone**, without associating any partner.\n\n" +
          "This is the core message of **every prophet**:\n" +
          "*\"Worship Allah; you have no deity other than Him.\"* — (Al-A'raf 7:59)\n\n" +
          "This is the Tawheed the mushrikeen **rejected**. It is the Tawheed Islam was sent to establish.",
        inline: false,
      },
      {
        name: `${E.stars} 3. Tawheed al-Asma was-Sifat — Oneness of Names & Attributes`,
        value:
          "Affirming for Allah all the names and attributes He has affirmed for Himself in the **Quran and authentic Sunnah** — without:\n" +
      ...
      {
        name: `${E.brain} Why does this categorisation matter?`,
        value:
          "It clarifies **where shirk actually occurs** (primarily in al-Uluhiyyah), and it protects us from misunderstanding Allah's nature. It is the methodology of the Salaf — the pious predecessors.",
        inline: false,
      },
    )
    .setFooter({ text: "unknownsubmitter  •  Methodology of Ahl al-Sunnah wal-Jama'ah" })
    .setTimestamp();
}
...
function islamImanIhsanEmbed() {
  return new EmbedBuilder()
    .setColor(0x37474F)
    .setTitle(`${E.brain}  Islam, Iman & Ihsan — The Three Levels of the Deen`)
    .setDescription(
      "*From the Hadith of Jibreel — one of the most comprehensive hadith in all of Islam*\n— (Sahih Muslim, Hadith 8)"
    )
    .addFields(
      {
        name: `${E.leaf} Islam — Submission`,
        value:
          "To:\n" +
          "• Testify the **Shahadah**\n" +
          "• Establish **Salah**\n" +
          "• Give **Zakah**\n" +
          "• Fast **Ramadan**\n" +
      ...
      {
        name: `${E.rose} Ihsan — Excellence & Perfection`,
        value:
          "**\"To worship Allah as if you see Him — and though you do not see Him, know that He sees you.\"**\n\n" +
          "The highest level. It transforms every act — prayer, speech, business, sleep — into an act of conscious devotion.\n\n" +
      ...
      },
      {
        ...
        value:
          "Every **Mu'min (believer)** is a Muslim — but not every Muslim has perfected Iman.\n" +
...
function prophetNamesEmbed() {
  return new EmbedBuilder()
    .setColor(0x880E4F)
    .setTitle(`${E.rose}  Names & Titles of the Prophet Muhammad ﷺ`)
    .setDescription(
    ...
    .addFields(
      ...
      { name: `${E.correct} Al-Hashir`,             value: "The Gatherer — mankind will be gathered at his feet on Yawm al-Qiyamah", inline: true },
      { name: `${E.correct} Al-Aqib`,               value: "The Last — there is no prophet after him", inline: true },
      {
        name: `${E.heart} Sending Salah upon the Prophet ﷺ`,
        value:
    ...
    .setFooter({ text: "unknownsubmitter  •  May Allah's peace and blessings be upon him ﷺ" })
    .setTimestamp();
}
...
function islamicCalendarEmbed() {
  return new EmbedBuilder()
    .setColor(0x4E342E)
    .setTitle(`${E.sandclock}  The Islamic Lunar Calendar`)
    .setDescription(
    ...
    .addFields(
      { name: "1. Muharram 🌙",      value: "Sacred month — contains **Ashura** (10th Muharram)", inline: true },
      { name: "2. Safar",            value: "Second month of the Hijri year", inline: true },
      { name: "3. Rabi al-Awwal",    value: "Birth of the Prophet ﷺ (12th) — month of great joy", inline: true },
      { name: "4. Rabi al-Thani",    value: "Fourth month of the Hijri year", inline: true },
      { name: "5. Jumada al-Awwal",  value: "Fifth month", inline: true },
      { name: "6. Jumada al-Thani",  value: "Sixth month", inline: true },
      { name: "7. Rajab 🌙",         value: "Sacred month — **Isra wal Mi'raj** (27th)", inline: true },
      { name: "8. Sha'ban",          value: "Contains **Laylatul Bara'ah** (15th) — month of deeds being raised", inline: true },
      { name: "9. Ramadan 🌙",       value: "Month of fasting — contains **Laylatul Qadr** (last 10 nights)", inline: true },
      { name: "10. Shawwal",         value: "**Eid al-Fitr** (1st) — 6 fasts of Shawwal are Sunnah", inline: true },
      { name: "11. Dhul Qa'dah 🌙",  value: "Sacred month — preparation for Hajj", inline: true },
      { name: "12. Dhul Hijjah 🌙",  value: "Sacred month — **Hajj** (8–13th), **Eid al-Adha** (10th)", inline: true },
      {
        name: `${E.stars} The Four Sacred Months`,
        value:
          "**Muharram, Rajab, Dhul Qa'dah, Dhul Hijjah**\n" +
          "*\"Fighting therein is a great sin.\"* — (Al-Baqarah 2:217)\n" +
          "Sins are heavier and worship is more rewarded in these months.",
        inline: false,
      },
    )
...
function sunnahPrayersEmbed() {
  return new EmbedBuilder()
    .setColor(0x006064)
    .setTitle(`${E.sun}  Sunnah & Voluntary Prayers`)
    .setDescription(
      "Beyond the 5 obligatory prayers, the Prophet ﷺ regularly performed additional prayers — each bringing one closer to Allah."
    )
    .addFields(
      {
      ...
      },
      {
        ...
        value:
          ...
          "Du'a al-Qunut is recited in the last rakaat (especially in Ramadan).",
        inline: false,
      },
      {
        name: `${E.correct} Salat ad-Duha`,
        value:
          "Prayed **after sunrise** (approx. 20 min after) until before Dhuhr.\n" +
          "Minimum: **2 rakaat** — Maximum: **12 rakaat**\n\n" +
          "*\"Whoever prays Fajr in congregation, then sits remembering Allah until sunrise, then prays 2 rakaat — he will have the reward of a complete Hajj and Umrah.\"*\n— (Tirmidhi, Hasan)",
        inline: false,
      },
      {
        name: `${E.correct} Salat al-Jumu'ah — Friday Prayer`,
        value:
          "**Obligatory upon Muslim men.** Replaces Dhuhr — **2 rakaat** after the khutbah.\n\n" +
          "*\"There is an hour on Friday where any Muslim who stands in prayer and asks Allah for something — Allah will surely grant it to him.\"*\n— (Bukhari & Muslim)\n" +
...
// ═══════════════════════════════════════════════════════════════
//  BUILD SLASH COMMANDS  (dynamic — rebuilt after CRUD changes)
// ═══════════════════════════════════════════════════════════════
function buildCommands() {
  ...
  // Names that have dedicated info commands — skip adding a dynamic cat cmd for these
  ...
  const cmds = [
    ...
    new SlashCommandBuilder().setName("qadar").setDescription("Qadar — Divine Decree, its four levels explained"),
    ...
    new SlashCommandBuilder().setName("islamimanihsan").setDescription("Islam, Iman & Ihsan — the three levels of the Deen"),
    new SlashCommandBuilder().setName("prophetnames").setDescription("Names and titles of the Prophet Muhammad ﷺ"),
    new SlashCommandBuilder().setName("islamiccalendar").setDescription("The Islamic Hijri calendar — all 12 months and key dates"),
    new SlashCommandBuilder().setName("sunnahprayers").setDescription("Sunnah & voluntary prayers — Tahajjud, Witr, Duha, Rawatib"),
  ...
  // ── Dynamic category commands (one per category, skip info-cmd conflicts)
